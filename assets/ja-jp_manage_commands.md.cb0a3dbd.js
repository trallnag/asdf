import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.0e8ae64e.js";const h=JSON.parse('{"title":"すべてのコマンド","description":"","frontmatter":{},"headers":[],"relativePath":"ja-jp/manage/commands.md","filePath":"ja-jp/manage/commands.md","lastUpdated":1704890757000}'),l={name:"ja-jp/manage/commands.md"},p=e(`<h1 id="すべてのコマンド" tabindex="-1">すべてのコマンド <a class="header-anchor" href="#すべてのコマンド" aria-label="Permalink to &quot;すべてのコマンド&quot;">​</a></h1><p><code>asdf</code>で利用可能なすべてのコマンドの一覧です。この一覧は、<code>asdf help</code>コマンドで表示されるテキストです。</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">MANAGE PLUGINS</span></span>
...
<span class="line"><span style="color:#24292e;">Docs:   https://asdf-vm.com</span></span></code></pre></div>`,3),t=[p];function o(i,c,r,d,g,f){return a(),n("div",null,t)}const m=s(l,[["render",o]]);export{h as __pageData,m as default};
