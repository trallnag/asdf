import{_ as s,o as a,c as n,Q as e}from"./chunks/framework.0e8ae64e.js";const m=JSON.parse('{"title":"All Commands","description":"","frontmatter":{},"headers":[],"relativePath":"manage/commands.md","filePath":"manage/commands.md","lastUpdated":1687069487000}'),l={name:"manage/commands.md"},t=e(`<h1 id="all-commands" tabindex="-1">All Commands <a class="header-anchor" href="#all-commands" aria-label="Permalink to &quot;All Commands&quot;">​</a></h1><p>The list of all commands available in <code>asdf</code>. This list is the <code>asdf help</code> command text.</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">MANAGE PLUGINS</span></span>
...
<span class="line"><span style="color:#24292e;">Docs:   https://asdf-vm.com</span></span></code></pre></div>`,3),p=[t];function o(i,c,r,d,g,f){return a(),n("div",null,p)}const h=s(l,[["render",o]]);export{m as __pageData,h as default};
